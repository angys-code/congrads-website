...
import { ArrowRight, Activity, Brain, Clock3, Gauge, ScanSearch, ShieldAlert, Sparkles } from 'lucide-react';
...
const topics: Topic[] = [
    {
        ...
        icon: Brain,
        accent: '#ff6666',
        prompts: ['heuristic biases', 'confirmation bias under stress', 'self-serving bias in conflict'],
    },
    {
        name: 'Human Behavior',
        ...
        icon: Activity,
        accent: '#ff8452',
        prompts: ['conformity in group settings', 'habit loops and friction', 'decision-making under social pressure'],
    },
    {
        name: 'Body Language',
        ...
        icon: ScanSearch,
        accent: '#ffbf55',
        prompts: ['posture shifts during tension', 'micro-expressions and pauses', 'defensive gestures in conversation'],
    },
    {
        name: 'Neuroscience',
        ...
        icon: Sparkles,
        accent: '#ff6a6a',
        prompts: ['memory consolidation and sleep', 'stress response and attention', 'dopamine, reward, and learning'],
    },
    {
        name: 'Forensics',
        ...
        icon: ShieldAlert,
        accent: '#ff4747',
        prompts: ['timeline reconstruction', 'evidence chain inconsistencies', 'witness reliability checks'],
    },
    {
        ...
        icon: Gauge,
        accent: '#f7d14d',
        prompts: ['creatine timing and dosage', 'caffeine stacking and tolerance', 'magnesium and recovery protocols'],
    },
];
